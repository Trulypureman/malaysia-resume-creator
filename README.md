...
- ⬇️ **Download as PDF** — One click, print-to-PDF via browser
...
| Key Skills | Required | Hard skills + soft skills (tag-based, ATS-optimised) |
| Languages | Optional | With proficiency level — important in MY market |
| Certifications & Training | Optional | HRDF, Google, CIDB, online certs |
| Awards & Achievements | Optional | Academic, professional recognition |
| Volunteer & Co-Curriculum | Optional | Clubs, societies, community service |
| Expected Salary & Availability | Optional | Notice period, relocation preference |
...
2. Click **Export .docx**
3. Open [Google Drive](https://drive.google.com) → Upload the downloaded `.docx` file
...
```bash
git clone https://github.com/yourusername/malaysia-resume-creator.git
cd malaysia-resume-creator
open index.html
```
...
| [docx.js](https://docx.js.org/) (CDN) | Generates real `.docx` Word files client-side |
| Google Fonts (DM Serif Display, DM Sans) | Typography |
| Browser Print API | PDF generation via print-to-PDF |

No frameworks. No build tools. No backend. Just one `index.html` file.
...
<p align="center">Created by <strong>AhChai</strong> with ❤️ Love</p>
